package com.uyr.yusara.dreamhome.News;
...
public class NewsMainActivity extends AppCompatActivity {
    ...
    class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            xml = Function.excuteGet("https://newsapi.org/v2/top-headlines?country=my&category=business&apiKey="+API_KEY, urlParameters);
            return  xml;
        }
        @Override
