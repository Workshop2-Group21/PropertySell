...
public class UpdateProductActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product = (Product) getIntent().getSerializableExtra("property");
    ...
    private void updateProduct() {
        ...
        if (!hasValidationErrors(name, brand, desc, price, qty)) {
            ...
            db.collection("property").document(product.getId())
                    .update(
                            "brand", p.getBrand(),
    ...
    private void deleteProduct() {
        db.collection("property").document(product.getId()).delete()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            finish();
                            startActivity(new Intent(UpdateProductActivity.this, ProductsActitvity.class));
                        }
                    }
                });
    }
